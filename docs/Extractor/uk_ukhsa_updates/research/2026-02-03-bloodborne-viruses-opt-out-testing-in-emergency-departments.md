...
seo:
  json_ld:
    ...
    "@graph":
      - "@type": "WebPage"
        "@id": "https://epialert.weiqi.kids/Extractor/uk_ukhsa_updates/research/2026-02-03-bloodborne-viruses-opt-out-testing-in-emergency-departments#webpage"
        url: "https://epialert.weiqi.kids/Extractor/uk_ukhsa_updates/research/2026-02-03-bloodborne-viruses-opt-out-testing-in-emergency-departments"
        name: "Research: Bloodborne viruses (BBVs): opt-out testing in emergency departments (EDs)"
        description: "來自 UK Health Security Agency 的研究資訊：Research: Bloodborne viruses (BBVs): opt-out testing in emergency departments (EDs)"
        inLanguage: "zh-TW"
        isPartOf:
        ...
        speakable:
          ...
          cssSelector:
            ...
            - ".faq-answer-content"
      - "@type": "Article"
        "@id": "https://epialert.weiqi.kids/Extractor/uk_ukhsa_updates/research/2026-02-03-bloodborne-viruses-opt-out-testing-in-emergency-departments#article"
        mainEntityOfPage:
          "@id": "https://epialert.weiqi.kids/Extractor/uk_ukhsa_updates/research/2026-02-03-bloodborne-viruses-opt-out-testing-in-emergency-departments#webpage"
          significantLink:
            - "https://www.gov.uk/government/publications/bloodborne-viruses-opt-out-testing-in-emergency-departments"
        headline: "Research: Bloodborne viruses (BBVs): opt-out testing in emergency departments (EDs)"
        description: "來自 UK Health Security Agency 的研究資訊：Research: Bloodborne viruses (BBVs): opt-out testing in emergency departments (EDs)"
        author:
      ...
      - "@type": "BreadcrumbList"
        itemListElement:
          ...
          - "@type": "ListItem"
            position: 4
            name: "Research: Bloodborne viruses (BBVs): opt-out testing in emergency departments (EDs)"
            item: "https://epialert.weiqi.kids/Extractor/uk_ukhsa_updates/research/2026-02-03-bloodborne-viruses-opt-out-testing-in-emergency-departments"
  ymyl:
