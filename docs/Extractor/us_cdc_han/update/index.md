...
seo:
  json_ld:
    - "@type": WebPage
      "@id": "https://epialert.weiqi.kids/Extractor/us_cdc_han/update/#webpage"
      url: "https://epialert.weiqi.kids/Extractor/us_cdc_han/update/"
      name: "update"
      description: "美國 CDC 健康警報網絡更新資訊索引"
      inLanguage: "zh-TW"
      isPartOf:
    ...
    - "@type": BreadcrumbList
      itemListElement:
        ...
        - "@type": ListItem
          position: 3
          name: "update"
          item: "https://epialert.weiqi.kids/Extractor/us_cdc_han/update/"
  ymyl:
