...
seo:
  json_ld:
    - '@context': 'https://schema.org'
      '@type': 'WebPage'
      '@id': 'https://epialert.weiqi.kids/Extractor/us_cdc_mmwr/surveillance_summary/2026/2026-02-05-lessons-learned-from-programmatic-gains-in-hiv-ser#webpage'
      url: 'https://epialert.weiqi.kids/Extractor/us_cdc_mmwr/surveillance_summary/2026/2026-02-05-lessons-learned-from-programmatic-gains-in-hiv-ser'
      name: 'Lessons Learned from Programmatic Gains in HIV Service Delivery During the COVID-19 Pandemic - 41 PEPFAR-Supported Countries, 2020'
      description: 'CDC MMWR surveillance summary extracted by EpiAlert AI system'
      inLanguage: 'en-US'
      isPartOf:
        '@id': 'https://epialert.weiqi.kids#website'
      breadcrumb:
        '@id': 'https://epialert.weiqi.kids/Extractor/us_cdc_mmwr/surveillance_summary/2026/2026-02-05-lessons-learned-from-programmatic-gains-in-hiv-ser#breadcrumb'
      potentialAction:
        '@type': 'ReadAction'
        target:
          - 'https://epialert.weiqi.kids/Extractor/us_cdc_mmwr/surveillance_summary/2026/2026-02-05-lessons-learned-from-programmatic-gains-in-hiv-ser'
      speakable:
    ...
    - '@context': 'https://schema.org'
      '@type': 'Article'
      '@id': 'https://epialert.weiqi.kids/Extractor/us_cdc_mmwr/surveillance_summary/2026/2026-02-05-lessons-learned-from-programmatic-gains-in-hiv-ser#article'
      headline: 'Lessons Learned from Programmatic Gains in HIV Service Delivery During the COVID-19 Pandemic - 41 PEPFAR-Supported Countries, 2020'
      description: 'CDC MMWR surveillance summary extracted by EpiAlert AI system'
