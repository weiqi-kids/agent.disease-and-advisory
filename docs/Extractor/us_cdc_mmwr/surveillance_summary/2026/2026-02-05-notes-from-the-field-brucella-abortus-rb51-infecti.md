...
seo:
  json_ld:
    - '@context': 'https://schema.org'
      '@type': 'WebPage'
      '@id': 'https://epialert.weiqi.kids/Extractor/us_cdc_mmwr/surveillance_summary/2026/2026-02-05-notes-from-the-field-brucella-abortus-rb51-infecti#webpage'
      url: 'https://epialert.weiqi.kids/Extractor/us_cdc_mmwr/surveillance_summary/2026/2026-02-05-notes-from-the-field-brucella-abortus-rb51-infecti'
      name: 'Notes from the Field: Brucella abortus RB51 Infections Associated with Consumption of Raw Milk from Pennsylvania --- 2017 and 2018'
      description: 'CDC MMWR surveillance summary extracted by EpiAlert AI system'
      inLanguage: 'en-US'
      isPartOf:
        '@id': 'https://epialert.weiqi.kids#website'
      breadcrumb:
        '@id': 'https://epialert.weiqi.kids/Extractor/us_cdc_mmwr/surveillance_summary/2026/2026-02-05-notes-from-the-field-brucella-abortus-rb51-infecti#breadcrumb'
      potentialAction:
        '@type': 'ReadAction'
        target:
          - 'https://epialert.weiqi.kids/Extractor/us_cdc_mmwr/surveillance_summary/2026/2026-02-05-notes-from-the-field-brucella-abortus-rb51-infecti'
      speakable:
    ...
    - '@context': 'https://schema.org'
      '@type': 'Article'
      '@id': 'https://epialert.weiqi.kids/Extractor/us_cdc_mmwr/surveillance_summary/2026/2026-02-05-notes-from-the-field-brucella-abortus-rb51-infecti#article'
      headline: 'Notes from the Field: Brucella abortus RB51 Infections Associated with Consumption of Raw Milk from Pennsylvania --- 2017 and 2018'
      description: 'CDC MMWR surveillance summary extracted by EpiAlert AI system'
