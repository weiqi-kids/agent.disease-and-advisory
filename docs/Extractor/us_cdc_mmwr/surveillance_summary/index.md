...
seo:
  json_ld:
    - "@type": "WebPage"
      "@id": "https://epialert.weiqi.kids/Extractor/us_cdc_mmwr/surveillance_summary#webpage"
      url: "https://epialert.weiqi.kids/Extractor/us_cdc_mmwr/surveillance_summary"
      name: "surveillance_summary"
      description: "US CDC MMWR 監測摘要分類索引，包含疾病監測、流行病學統計等監測報告"
      inLanguage: "zh-TW"
      isPartOf:
