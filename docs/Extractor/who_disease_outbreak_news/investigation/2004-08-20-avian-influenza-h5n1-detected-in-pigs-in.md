...
seo:
  json_ld:
    - type: WebPage
      id: 'https://epialert.weiqi.kids/Extractor/who_disease_outbreak_news/investigation/2004-08-20-avian-influenza-h5n1-detected-in-pigs-in#webpage'
      speakable:
        cssSelector:
          - .article-summary
          - .speakable-content
          ...
          - .faq-answer-content
    - type: Article
      id: 'https://epialert.weiqi.kids/Extractor/who_disease_outbreak_news/investigation/2004-08-20-avian-influenza-h5n1-detected-in-pigs-in#article'
    ...
    - type: BreadcrumbList
      items:
        ...
        - position: 3
          name: 'Avian influenza: H5N1 detected in pigs in China'
          url: 'https://epialert.weiqi.kids/Extractor/who_disease_outbreak_news/investigation/2004-08-20-avian-influenza-h5n1-detected-in-pigs-in'
  ymyl:
    lastReviewed: '2004-08-20'
...
中國哈爾濱獸醫研究所的研究人員報告在中國部分地區的豬場中檢測到H5N1禽流感病毒。這是首次報告豬的H5N1自然感染。WHO已要求進一步確認和詳細資料。
