...
date: 2009-06-15
confidence: 高
who_id: "ac59185f-b83a-46ee-b76a-022b58a0bb4a"
regions: [America,Argentina,As,Australia,Austria,Bahamas,Bahrain,Barbados,Belgium,Bolivia]
diseases: [H1N1,influenza,Influenza]
seo:
  json_ld:
    - type: WebPage
      id: 'https://epialert.weiqi.kids/Extractor/who_disease_outbreak_news/update/2009-06-15-influenza-a-h1n1-update-49#webpage'
      speakable:
        cssSelector:
          - .article-summary
          - .speakable-content
          ...
          - .faq-answer-content
    - type: Article
      id: 'https://epialert.weiqi.kids/Extractor/who_disease_outbreak_news/update/2009-06-15-influenza-a-h1n1-update-49#article'
    ...
    - type: BreadcrumbList
      items:
        ...
        - position: 3
          name: 'Influenza A(H1N1) - update 49'
          url: 'https://epialert.weiqi.kids/Extractor/who_disease_outbreak_news/update/2009-06-15-influenza-a-h1n1-update-49'
  ymyl:
    lastReviewed: '2009-06-15'
...
Laboratory-confirmed cases of new in
