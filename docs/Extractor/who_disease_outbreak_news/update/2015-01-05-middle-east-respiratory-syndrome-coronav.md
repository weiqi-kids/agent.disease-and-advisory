...
seo:
  json_ld:
    - type: WebPage
      id: 'https://epialert.weiqi.kids/Extractor/who_disease_outbreak_news/update/2015-01-05-middle-east-respiratory-syndrome-coronav#webpage'
      speakable:
        cssSelector:
          - .article-summary
          - .speakable-content
          ...
          - .faq-answer-content
    - type: Article
      id: 'https://epialert.weiqi.kids/Extractor/who_disease_outbreak_news/update/2015-01-05-middle-east-respiratory-syndrome-coronav#article'
    ...
    - type: BreadcrumbList
      items:
        ...
        - position: 3
          ...
          url: 'https://epialert.weiqi.kids/Extractor/who_disease_outbreak_news/update/2015-01-05-middle-east-respiratory-syndrome-coronav'
  ymyl:
    lastReviewed: '2015-01-05'
...
沙烏地阿拉伯在2014年12月19日至30日期間,向WHO通報3例中東呼吸症候群冠狀病毒(MERS-CoV)感染新增確診病例,包括1例死亡。
